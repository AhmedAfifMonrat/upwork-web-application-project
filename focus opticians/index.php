...
<div id="head"> 
<div id="menu">
<a href="#" class="active" name="home_page">Home</a></a>
<a href="#about_page" style="margin-left:15px">About</a>
<a href="#contact_page" style="margin-left:15px">Contact</a>
</div>
<div id="welcome_text">
...
<a href="#" class="active" name="about_page" style="margin-left:15px">About</a>
<a href="#contact_page" style="margin-left:15px">Contact</a>
</div>
...
<a href="#home_page">Home</a>
<a href="#about_page" style="margin-left:15px">About</a>
<a href="#" class="active" name="contact_page" style="margin-left:15px">Contact</a>
</div>
<div id="map">
<div class="map1">
<div class="ZoomIt">
...
<tr>
<td>Phone:</td>
<td style="float:right">(415) 457-8170</td>
</tr>
<tr>
<td>Fax:</td>
<td style="float:right">(415) 457-8170</td>
...
<table border="0" style="color:#FFFFFF; margin-top:35px" width="400px">
<tr>
<td>Email:</td>
<td style="float:right">focusopticians@gmail.com</td>
</tr>
</table>
</div>
</div>
...
<td height="20">
<select id="date" name="date" style="width:180px;height:30px; padding:5px; margin-left:30px; text-transform:uppercase; color:#666666; font-weight:700">
...
<td>
<input type="text" name="email" id="email" value="Email Address" style="width:180px; height:30px; text-align:center; margin-left:40px;text-transform:uppercase;color:#666666; font-weight:700" onFocus="if(this.value!='')this.value=''" onBlur="if(this.value=='') this.value='email Address'" />
</td>
<td>
<input type="text" name="phone" id="phone" value="Phone Number" style="width:180px;height:30px;text-align:center; margin-left:40px;text-transform:uppercase;color:#666666; font-weight:700" onFocus="if(this.value!='')this.value=''" onBlur="if(this.value=='') this.value='phone number'" />
</td>
<td>
<input type="button" name="submit" id="submit" value="Submit" style="width:130px;height:30px; margin-left:60px;text-transform:uppercase;color:#ffffff; font-weight:700; background-color:#FF0000" />
</td>
</tr>
</table>
</form>
...
<a href="" style="text-decoration:none; color:#FFFFFF">Design, Development and Presentation by <strong>Zenith Solutions Group</strong></a>
</div>
</div>
</div>
</div>
